  ...
  return (
    ...
    >
      {/* Image placeholder -- swap for real photography later.
          Order alternates left/right on desktop for visual rhythm. */}
      <div
        className={`${reversed ? "md:order-2" : "md:order-1"}`}
      >
        <div
          className={`aspect-[4/3] rounded-lg border border-line2 bg-gradient-to-br ${gradients[index % gradients.length]} flex flex-col items-center justify-center gap-2`}
        >
