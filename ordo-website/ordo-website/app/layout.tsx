...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${display.variable} ${body.variable} ${mono.variable} font-body bg-cloud text-slate antialiased`}
      >
        <script
        ...
        {/* Navbar + Footer render once here, so every page under app/
            automatically gets the same nav and footer -- no copy-pasting per page. */}
        <Navbar />
        {children}
        <Footer />
      </body>
