...
export const metadata: Metadata = {
  ...
  description:
    "Ordo District Cooling Services -- specialist technical services for the UAE's district cooling operators, plant managers, and cooling network owners. Central plants, distribution networks, ETS, metering, and 24/7 emergency response.",
};
